...
/*
	This program will use the Applet function 
	to create faces with the loop function to
	help with creating the different faces.
...
public class MultipleFaces extends JApplet {
	...
	public void paint(Graphics canvas){
		...
		//Draw mouth:
		canvas.setColor(Color.BLACK);
		canvas.drawArc(X_MOUTH0 + xOffset, Y_MOUTH0 + yOffset, MOUTH_WIDTH, MOUTH_HEIGHT0 + 3 * (i - 2), MOUTH_START_ANGLE, MOUTH_EXTENT_ANGLE);
